...
> Fatia atual: **2 — Telas 1–3 no front** (`WIP`)
...
| 2 | Telas 1–3 no front (Setup, Nível, Lista) | `WIP` | [slices/02-telas-1-3.md](./slices/02-telas-1-3.md) | UI hifi com recálculo instantâneo |
