...
> Fatia atual: **1 — Catálogo e seed de preços** (`WIP`)
...
| 1 | Catálogo e seed de preços + API de estimativa | `WIP` | [slices/01-catalogo-seed.md](./slices/01-catalogo-seed.md) | `GET /catalog/tiers`, `POST /barbecues/estimate`, pacote compartilhado |
| 2 | Telas 1–3 no front (Setup, Nível, Lista) | `TODO` | [slices/02-telas-1-3.md](./slices/02-telas-1-3.md) | UI hifi com recálculo instantâneo |
| 3 | Auth (cadastro/login) + persistência | `TODO` | [slices/03-auth.md](./slices/03-auth.md) | JWT, users, banco + salvar churras |
| 4 | Sharing: slug, link público, QR Code, Pix | `TODO` | [slices/04-sharing.md](./slices/04-sharing.md) | Telas 4–6, payload Pix EMV, página pública |
